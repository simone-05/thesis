...
export class ViewComponent implements OnDestroy, OnInit {
  ...
  constructor(public graphEditingService: GraphEditingService, private activatedRoute: ActivatedRoute, private fm: FuncManagerService) {
    this.nodeDetails = "-1";
    this.edgeDetails = "0";
    ...
    this.graph_update = this.graphEditingService.graph$.subscribe((element: any) => {
      if (element) {
        this.updateGraph();
      }
    });
